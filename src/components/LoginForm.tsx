        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00a884] focus:border-transparent outline-none transition"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#00a884] text-white py-2.5 px-4 rounded-lg hover:bg-[#008f72] disabled:bg-gray-300 disabled:cursor-not-allowed transition font-medium"
          >
