    ...
    <div className='min-h-screen bg-[#f0f2f5]'>
      <nav className='flex items-center justify-between px-6 py-4 max-w-7xl mx-auto'>
        ...
        <div className='flex gap-4 items-center'>
          ...
          <a
            href='/chat/login'
            className='bg-[#00a884] text-white px-4 py-2 rounded-full font-medium hover:bg-[#008f72] transition'
          >
            Get Started
          </a>
        </div>
      ...
      <main className='max-w-7xl mx-auto px-6 py-20'>
        <div className='text-center mb-16'>
          <h1 className='text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight'>
            Connect instantly,
            <br />
            <span className='text-[#00a884]'>chat seamlessly</span>
          </h1>
          <p className='text-xl text-gray-600 mb-8 max-w-2xl mx-auto'>
            A modern messaging experience designed for real-time conversations. Start chatting in seconds with
            our beautiful, intuitive interface.
          </p>
          <div className='flex gap-4 justify-center'>
            <a
              href='/chat/login'
              className='bg-[#00a884] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#008f72] transition shadow-lg shadow-[#00a884]/20'
            >
              Start Chatting
            </a>
            <a
        ...
        <div id='features' className='grid md:grid-cols-3 gap-8 mb-20'>
          <div className='bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition'>
            <div className='w-12 h-12 bg-[#00a884]/10 rounded-xl flex items-center justify-center mb-4'>
