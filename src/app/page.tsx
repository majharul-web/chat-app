  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        <div className="text-2xl font-bold text-gray-900">ChatApp</div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            Connect instantly,
            <br />
            <span className="text-blue-600">chat seamlessly</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            A modern messaging experience designed for real-time conversations. 
            Start chatting in seconds with our beautiful, intuitive interface.
          </p>
          <div className="flex gap-4 justify-center">
            <a
              href="/chat/login"
              className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition shadow-lg shadow-blue-200"
            >
              Start Chatting
            </a>
            <a
        ...
        <div id="features" className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Messages appear instantly with live updates. No refresh needed, just pure seamless conversation flow.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Create group chats with multiple participants. Perfect for teams, friends, and family discussions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Built with modern design principles, our chat interface is clean, responsive, and a joy to use. 
                Whether you&apos;re on desktop or mobile, the experience is perfectly tailored for your device.
              </p>
              <ul className="space-y-3">
                {['Responsive design for all devices', 'Smooth animations and transitions', 'Dark mode support', 'Accessible to everyone'].map((feature) => (
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-4">
                ...
                <div className="bg-gray-100 rounded-lg p-3 text-sm text-gray-700">Hey! How are you doing?</div>
              </div>
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 ml-8">
                <div className="bg-blue-600 rounded-lg p-3 text-sm text-white">I&apos;m great, thanks for asking! 🎉</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-600 mb-8 max-w-xl mx-auto">
            Join thousands of users already enjoying seamless communication. Sign up now and start your first conversation in seconds.
          </p>
          <a
            href="/chat/login"
