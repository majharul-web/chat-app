...
import { User, Message, Conversation, MessagesResponse } from '@/types';
...
export const chatApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    createConversation: builder.mutation<Conversation, { userId: string; type: 'direct' | 'group'; name?: string }>({
      query: (body) => ({
        url: '/api/conversations',
        method: 'POST',
        body,
